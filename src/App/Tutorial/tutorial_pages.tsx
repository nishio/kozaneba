...
type HelpPage = { title: string; body: JSX.Element };
  ...
  },
  {
    ...
    body: (
      <div>
        ...
        <p>
          The following pages will explain the advanced features and the
          philosophy behind Kozaneba.
        </p>
      </div>
    ),
  },
...
const foo = {
  ...
  body: (
    <div>
      ...
      <p>
        Kozane is a tool to recombine and rearrange information. By doing this,
        we often find connections between kozane that seem to have nothing
        related to each other. After discovering unexpected relationships,
        kozane is organized into a structure that you did not anticipate
        beforehand.
      </p>
      <p>
        Kozane is like fish. If you put them into where they can not swim, they
        will die. Don't classify kozane by its content, but organize them by
...
export const old_tutorial_pages = [
  <div>
